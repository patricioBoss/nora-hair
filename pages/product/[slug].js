...
import SimillarSwiper from "../../components/productPage/infos/SimillarSwiper";
    ...
    <>
      ...
      <div className={styles.product}>
        <div className={styles.product__container}>
          ...
          {/* <div>
          <h3 className=" font-bold text-2xl mt-7 mb-2">View similar Products</h3>
          <SimillarSwiper className={" max-w-full"}/>
          </div> */}
          <div>
