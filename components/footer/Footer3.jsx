      ...
      <div className="px-4 py-16 mx-auto max-w-screen-xl sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-5">
          <div className=" lg:col-span-3">
            ...
            Whether you&apos;re looking for a natural-looking wig or a bold and vibrant braid, 
            Norahairforest has something for everyone. With exceptional customer service and a dedication to customer satisfaction, Norahairforest is the go-to choice for all your hair wig and braid needs.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 gap-10 lg:col-span-2 sm:grid-cols-2 lg:grid-cols-2">
            <div>
              ...
              <nav className="flex flex-col mt-4 text-sm text-gray-100 space-y-2">
                <a
                  className="hover:opacity-75 flex gap-4 md:text-center w-full "
                ...
                <div className="flex flex-col items-start">
                  <br />
                  <p className="font-medium text-white text-left">Address</p>
                  Office B102 Emirate shopping mall Divine estate Amuwo very close to Ago bridge, Amuwo, Lagos, Nigeria,
                  <br />
                </div>
            ...
            <div>
              ...
              <nav className="flex flex-col mt-4 text-sm items-start text-gray-100 space-y-2">
                <a
        ...
        <div className="mt-16 border-t border-white/10 pt-8 sm:mt-20 md:flex md:items-center md:justify-between lg:mt-24">
            ...
            <p className="mt-8 text-xs leading-5 text-gray-400 md:order-1 md:mt-0">
              &copy; 2020 Your NoraHairForest All rights reserved.
            </p>
          </div>
      </div>
    </footer>
