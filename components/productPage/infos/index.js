    ...
    <div className={styles.infos}>
      ...
      <div className={styles.infos__container}>
        ...
        <div className="mt-10 px-4 sm:mt-16 sm:px-0 lg:mt-0">
          ...
          <div className="mt-3">
            ...
            <p className="text-sm my-3">
              ...
              <span className="line-through">
                {fCurrency(product.priceBefore)}
              </span>{" "}
              <span className=" p-1 bg-gray-300 font-medium rounded text-gray-900">
                -{product.discount}%
              </span>
            </p>
          </div>
          ...
          <RadioGroup
            value={product.sizes[router.query.size] ?? product.sizes[0]}
            className="mt-2"
          >
